...
const firstName = "Batikan";
const lastName = "Sevil";
...
console.log('Ex.25', incrementedValue2);

// 26. Declare numberEx11=-3. Increment it by 1 using prefix ++, then multiply the result by 2 and log the final value.

let numberEx11 = -3;
++numberEx11;
let finalValueEx11 = numberEx11 * 2;
...
let newB = 3;
++newA;
let newResult = newA + newB;
console.log('Ex.27', newResult);