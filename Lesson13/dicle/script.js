...
const floorNumber = 3.7;
const ceilNumber = 3.2;
console.log('Ex. 12', Math.floor(floorNumber), Math.ceil(ceilNumber));
...
let points = 10;
const plusPoint = (points += 5);
console.log('Ex. 15', points, plusPoint);

// 16. Declare name="Alice", age=30, city="Paris". Log "Alice (30) lives in Paris" using template literals.
const name = 'Alice';
const age = '30';
const city = 'Paris';
console.log('Ex. 16', `${name} ${age} lives in ${city}`); //Can't do the paranthesis?

// 17. Declare variables x=5, y=10, z=15. Log their total sum.
const xNumber = 5;
const yNumber = 10;
const zNumber = 15;
const totalSum = xNumber + yNumber + zNumber;
...
let counter4 = (counter2 += 1);
let counter5 = counter2 + 1;
...
console.log('Ex. 24', numberEx9, incrementedNumber);

// 25. Declare numberEx10=8. Increment it using the postfix ++ operator and log both the original variable and the incremented value.
let numberEx10 = 8;
let incremented8 = numberEx10++;
console.log('Ex. 25', numberEx10, incremented8);

// 26. Declare numberEx11=-3. Increment it by 1 using prefix ++, then multiply the result by 2 and log the final value.
let numberEx11 = -3;
let multipliedNum = numberEx11++ * 2;
console.log('Ex. 26', multipliedNum);

// 27. Declare a=2 and b=3. Increment a using the prefix ++ operator, then add b to the result and log it.
let aNum = 2;
let bNum = 3;
let incrementedANum = ++aNum;
let incrementedNumbers = incrementedANum + bNum;
console.log('Ex. 27', incrementedNumbers);
