...
const number1 = 3.7;
const number2 = 3.2;
console.log('Ex.12', Math.floor(number1), Math.ceil(number2));
...
console.log('Ex.18', "Division:" , divisionResult, "Difference:" , differenceResult);
...
console.log("Ex.22 counterSecond++", counterSecond);

counterSecond = counterSecond + 1;

console.log("Ex.22 counterSecond = counterSecond + 1", counterSecond);

counterSecond=+1
console.log("Ex.22 counterSecond=+1", counterSecond );
...
let numberEx9=6;
console.log('Ex.24: first value', numberEx9);
let incrementedNumber = ++numberEx9;

console.log('Ex.24: after increment:', incrementedNumber);
console.log('Ex.24: original value of first variable:', numberEx9);

// 25. Declare numberEx10=8. Increment it using the postfix ++ operator and log both the original variable and the incremented value.
// CODE HERE

let numberEx10=8;
console.log('Ex.25: first value', numberEx10);

let incrementedNumberEx10 = numberEx10++;
console.log('Ex.25: after increment:', incrementedNumberEx10);
console.log('Ex.25: original value of the first variable:', numberEx10);
