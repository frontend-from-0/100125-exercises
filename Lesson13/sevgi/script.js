...
const age = 30;
const city = 'Paris';
console.log('Ex.16', `${userName2} (${age}) lives in ${city}.`); 
...
const dividend = 10;
const divisor = 3;
const divisionResult = dividend / divisor;         // 10 ÷ 3 = 3.333...
const differenceResult = dividend - divisor;       // 10 - 3 = 7
const remainderResult = dividend % divisor;        // 10 % 3 = 1
console.log('Ex.18 - Division:', divisionResult);
console.log('Ex.18 - Difference:', differenceResult);
console.log('Ex.18 - Remainder:', remainderResult);  

// 19. Declare firstName and lastName. Create fullName by concatenating them with a space and log it.
// CODE HERE
const myFirstname = 'Sevgi';
const myLastname = 'Kilic';
...
let counterr = 0;
counterr++
console.log('Ex.22 (1)', counterr);
counterr+=1
console.log('Ex.22 (2)', counterr);
counterr=counterr+1
console.log('Ex.22 (3)', counterr);
...
// CODE HERE
let numberEx9 = 6;
console.log('Ex.24', numberEx9, ++numberEx9);  // 6, 7
