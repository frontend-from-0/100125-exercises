...
// CODE HERE
const firstName = "Basar";
const middleName = "Yigit";
const lastName = "Sakalli";
...
let counterr = 0;
counterr++;
console.log('Ex.22 after counter++:', counterr);
counterr += 1;
console.log('Ex.22 after counter+=1:', counterr);
counterr = counterr + 1;
console.log('Ex.22 after counter=counter+1:', counterr);
...
// CODE HERE
let numberEx10 = 8;
let incrementedPostfix = numberEx10++;
console.log('Ex.25', incrementedPostfix, numberEx10);

// 26. Declare numberEx11=-3. Increment it by 1 using prefix ++, then multiply the result by 2 and log the final value.
// CODE HERE
let numberEx11 = -3;
let incrementedAndMultiplied = ++numberEx11 * 2;
console.log('Ex.26', incrementedAndMultiplied);
