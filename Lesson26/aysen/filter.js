...
const moreThanTenWords = sentencesExercise5.filter((sentence) => sentence.split(' ').length > 10);
console.log('Ex5:',moreThanTenWords);
...
const outOfStock = productsExercise6.filter((product => product.quantity===0))
console.log("Ex6:", outOfStock);
...
const divisibleBy3 = numbersExercise7.filter((num =>num % 3 === 0));
console.log("Ex7:" , divisibleBy3);
...
const moreThanFiveChar = wordsExercise8.filter((word => word.length>5));
console.log("Ex8:", moreThanFiveChar);
...
console.log("Ex9:", studentsWithLowGrades);
...
const nameStartingWithJ= usersExercise10.filter((user) => user.name[0]==="J");
console.log("Ex10:", nameStartingWithJ);