...
const sum= numbersEx1.reduce((acc,curr) => acc + curr);
console.log("Ex1:", sum);
...
const maxNum= numbersEx2.reduce((acc,curr) => Math.max(acc, curr), -Infinity);

console.log("Ex2:", maxNum);
...
const sumOfNum = numbersEx4.reduce((acc,curr)=> acc+curr );
const averageOfNum = sumOfNum/numbersEx4.length;
console.log("Ex:4",averageOfNum);
