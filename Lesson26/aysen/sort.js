...
console.log("Ex1:",sortedNumbers, numbers);
...
const descendingOrderScores= [...scores].sort((a, b) => b - a);
console.log("Ex3:descending", descendingOrderScores);

const ascendingOrderScores = [...scores].sort((a, b) => a - b);
console.log("Ex3:ascending", ascendingOrderScores);
...
console.log("Ex4:", ascendingOrder);
...
const sortedByLengthsOfWords= [...words].sort((acc,curr) => acc.length- curr.length);
console.log("Ex5:", sortedByLengthsOfWords);
