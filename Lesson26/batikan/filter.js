...
const lessThan25 = usersExercise4.filter(user => user.age < 25);
...
const moreThan10 = sentencesExercise5.filter(sentence => {
...
const moreThanFive = wordsExercise8.filter(word => word.length > 5);
...
const startsWith = usersExercise10.filter(user => user.name.toLowerCase().startsWith("j"));
