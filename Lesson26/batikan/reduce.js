...
const sumEx1 = numbersEx1.reduce((acc, num) => acc + num, 0);
console.log(sumEx1);
console.log();
...
const maxValue = numbersEx2.reduce((acc, num) => num > acc ? num : acc, -Infinity);
...
// If we think this function's iteration process a for loop, then we can understand this concept easier.


// Exercise 4:
// Calculate the average of all numbers in the given array.
const numbersEx4 = [10, 20, 30, 40, 50];
const avgValue = numbersEx4.reduce((acc, num) => acc + num) / 5;
...
// This one doesn't count duplicate values then providing us length of that array(without duplicated values)
