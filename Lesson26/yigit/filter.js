...
const sentencesWithMoreThan10Words = sentencesExercise5.filter(sentence => sentence.split(' ').length > 10);
console.log(sentencesWithMoreThan10Words);
...
const moreThan5Chars = wordsExercise8.filter(word => word.length > 5);
console.log(moreThan5Chars);
